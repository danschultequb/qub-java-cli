    ...
    public static void test(final TestRunner runner)
    {
        runner.testGroup("DeleteAction", () ->
        {
            runner.testGroup("run(Console)", () ->
            {
                ...
                runner.test("with " + runner.escapeAndQuote("/fileThatDoesntExist.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-flag /fileThatDoesntExist.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-files /fileThatDoesntExist.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-file fileThatDoesntExist.txt"), (Test test) ->
                {
                    final Console console = new Console(new String[] { "delete", "-file", "fileThatDoesntExist.txt" });
                ...
                runner.test("with " + runner.escapeAndQuote("/fileThatExists.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-file /fileThatExists.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-files /fileThatExists.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-folder /folderThatDoesntExist"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("/folderThatExists"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-folder /folderThatExists"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-folders /folderThatExists"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("existingFileAndFolder.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-file existingFileAndFolder.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-folder existingFileAndFolder.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-file -folder existingFileAndFolder.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("-file -folder nonExistingFileAndFolder.txt"), (Test test) ->
                {
                ...
                runner.test("with " + runner.escapeAndQuote("undeletableExistingFile.txt"), (Test test) ->
                {
